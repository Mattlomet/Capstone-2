...
public class ControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> levelUpFailure(DataRetrievalFailureException e, WebRequest request) {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> viewModelValidation(MethodArgumentNotValidException e, WebRequest request) {
